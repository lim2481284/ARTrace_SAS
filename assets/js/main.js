...
function up(){
	...
	function down(){
		...
		function info_fly_out(){
			$('.wrapper').addClass('profile-detail-flyout');
			$('.wrapper-bottom').addClass('profile-mood-flyout');
			$('.wrapper-left').addClass('profile-image-flyout');
			setTimeout(function(){
				$('.wrapper-bottom').attr('class','wrapper-bottom');
				$('.wrapper-left').attr('class','wrapper-left');
				$('.wrapper').attr('class','wrapper');
			}, 800);
		}
		function recommendation_fly_in(){
			$('.recommendation-left').addClass('recommendation-left-flyin');
			$('.recommendation-right').addClass('recommendation-right-flyin');
		}
		function recommendation_fly_out(){
			$('.recommendation-left').addClass('recommendation-left-flyout');
			$('.recommendation-right').addClass('recommendation-right-flyout');
			setTimeout(function(){
				$('.recommendation-left').attr('class','recommendation-left');
				$('.recommendation-right').attr('class','recommendation-right');
			}, 800);

		}
		function checklist_fly_in(){
			$('.checklist-right').addClass('checklist-right-flyin');
			$('.checklist-bottom').addClass('checklist-bottom-flyin');
		}
		function checklist_fly_out(){
			$('.checklist-right').addClass('checklist-right-flyout');
			$('.checklist-bottom').addClass('checklist-bottom-flyout');
			setTimeout(function(){
				$('.checklist-right').attr('class','checklist-right');
				$('.checklist-bottom').attr('class','checklist-bottom');
			}, 800);
		}
